...
# conversation_data = pd.read_csv('jury_conversations_with_outcome_var.csv')
...
from features.sentiment_features_2 import * # TPM TAKE-HOME: THIS IS THE FILE YOU'LL EDIT!
...
if __name__ == "__main__":
	...
	OUTPUT_FILE_PATH_CHAT_LEVEL = './output/jury_output_chat_level_remove_words.csv'
	...
	output_data_chats = create_chat_level_feature(output_data_chats, "sentiment_1", get_sentiment_1)
	output_data_chats = create_chat_level_feature(output_data_chats, "sentiment_2", get_sentiment_2)
